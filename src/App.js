...
import Contact from './components/HomeElm/Contact';
import Cta from './components/HomeElm/Cta';
import Faq from './components/HomeElm/Faq';
import Footer from './components/HomeElm/Footer';
import Service from './components/HomeElm/Services';
import Teamshow from './components/HomeElm/Teamshow';
import Header from './components/HomeElm/Header';
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                ...
                <h2>We are team of IoT Developer making your solutions is Better</h2>
                <div class="d-lg-flex">
                  <a href="/auth" class="btn-get-started scrollto">Get Started</a>
